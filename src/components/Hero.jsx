  ...
  return (
    <div className="text-center bg-[#0d4875] p-6">
      <div className="flex flex-col gap-4">
        <h1 className="text-2xl font-bold text-[#ffff00]">
          🕌 Ubah Waktu Bermain Si Kecil Menjadi{" "}
          <span className="text-white">Investasi Pahala Jariyah</span> untuk
          Ayah Bunda
        </h1>
        <p className=" text-white text-lg">
          Bukan sekadar bermain, tapi aktivitas yang menanam nilai islami sejak
          dini dan terus mengalirkan pahala.😍
        </p>
        ...
        <p className="text-lg text-white">
          ...
          Penuh Warna yang Didesain Khusus Agar Si Kecil Belajar Sambil Bermain
          Tanpa Merasa Bosan
        </p>
        <div className="p-4 my-4 rounded-md shadow-md text-start bg-white">
          ...
          <p>
            ❌ Si kecil lebih cepat menghafal lagu tiktok daripada doa-doa
            harian
          </p>
          <p>
            ❌ Ingin aktivitas yang mendidik, tapi tetap seru dan nggak bikin
            anak bosan
          </p>
          <p>❌ Waktu berkualitas bersama anak sering tergeser oleh gadget</p>
          <p>❌ Buku belajar mahal & cepat habis isinya</p>
          <p>
            ❌ Ingin menanamkan nilai-nilai Islam, tapi masih bingung cara yang
            menyenangkan
          </p>
        </div>
